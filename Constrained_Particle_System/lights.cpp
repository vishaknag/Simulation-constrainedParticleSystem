...
void lightInit()
{
	...
	setSpecLevel = 1; //Whether the specularity parameter is turned on
...
//------------------------------
	...
	//	LIGHT 7
	// ---------------------
	GLfloat lightColor7[] = {1.0f, 1.0f, 1.0f, 1.0f};
//	GLfloat lightPos7[] = {1.9, 1.9, 1.9, 1.0 };
	GLfloat lightPos7[] = {-2.0, 1.0, 2.0, 1.0 };
	...
	//	LIGHT 8
	// ---------------------
	GLfloat lightColor8[] = {1.0f, 1.0f, 1.0f, 1.0f};
